...
#define AFTER_MENU_BAR_EVENT_PRIORITY 202
#define COMPOSER_EVENT_PRIORITY 203
#define PATCH_EVENT_PRIORITY 204
#define PATCH_TITLE_EVENT_PRIORITY 205
#define CONSOLE_LOG_EVENT_PRORITY 206

#define SCALE_SENSITIVITY 0.001f
#define MAX_SCALE 1.5f
#define MAX_SCALE_STEP .06f
#define MIN_SCALE .5f
